...
public class HttpManagerImpl extends HttpManager {
    ...
    public Response doRequest(Request request) throws HttpTimeoutException, IOException {
        ...
        // Set any extra cookies generated by the interceptor
        if (request.getExtraCookies() != null) {
            final CookieStore cookieStore = this.client.getCookieStore();
            for (Cookie cookie: request.getExtraCookies()) {
